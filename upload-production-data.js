...
console.log(`Prepared ${productionData.length} listings for upload:`);
productionData.forEach((listing, index) => {
  console.log(`${index + 1}. ${listing.title} (${listing.ltype}) - ${listing.city}, ${listing.country}`);
});
